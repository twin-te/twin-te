...
import { Event, Module } from "../../schoolcalendar/v1/type_pb";
import { RegisteredCourse } from "../../timetable/v1/type_pb";
...
export class GetByDateResponse extends Message<GetByDateResponse> {
  ...
  /**
   * @generated from field: schoolcalendar.v1.Module module = 2;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "module", kind: "enum", T: proto3.getEnumType(Module) },
