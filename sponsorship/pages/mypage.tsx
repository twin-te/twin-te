...
import type { Subscription, User } from "@/domain";
...
import { type PaymentHistory, PaymentTypeMap } from "../domain/payment_history";
				...
				{user ? (
					<>
						<div className="card">
							...
							<button
								className={`button is-text ${styles.editButton}`}
									...
									<table>
										...
										<tbody>
											<tr key={activeSubscription.id}>
												...
												<td>
													{activeSubscription.createdAt.format("YYYY.MM.DD")}
												</td>
												<td>
													<button
											...
											{paymentHistories
												...
												.map((paymentHistory) => (
													<tr key={paymentHistory.id}>
														<td>
															{paymentHistory.createdAt.format("YYYY-MM-DD")}
														</td>
														<td>
														...
														<td>
															<p className="has-text-grey">
																{PaymentTypeMap[paymentHistory.type]}
															</p>
														</td>
													</tr>
												))}
					...
					<p>
						右上の「<span className="has-text-weight-bold">ログイン</span>
						」ボタンからログインしてください。
					</p>
				)}
			</div>
