			...
			<div className={styles.content}>
				...
				<p>
					...
					<span className="has-text-weight-bold">
						広告なしで無料の筑波大学生専用時間割アプリ
					</span>
					」という構想で開発していますが、
					Twin:teの運用にはどうしても資金が必要です。
				</p>
				<p>
				...
				<p>
					また、Twin:te
					の開発は現在も続いておりますが、メンテナンスや機能の追加等で
					主要メンバーの時間的負担も大きくなっています。 Twin:te
					主要メンバーが負担できる時間的・金銭的なコストにも限度があります。
				</p>
				<p>
					そのような経緯があり、またありがたいことに「
					<span className="has-text-weight-bold">Twin:teに寄付をしたい</span>
					」との声を多数いただいておりますので、
					このような場を設けさせていただきました。
				</p>
				<p>
				...
				<p>
					...
					<a href="https://github.com/twin-te">Twin:teのGitHubレポジトリ</a>
					をご覧ください。
				</p>
				<p>
				...
				<p>
					Twin:teは決済処理の全てを<a href="https://stripe.com/jp">Stripe</a>
					に委託しております。
					<br />
